...
void Demo::Update(double deltaTime) {
	angle += (float)((deltaTime * 0.7f) / 1000);
}
...
void Demo::BuildColoredCube() {
	...
	float vertices[] = {
		...
		// front
		-0.8, -1, 0.3, 0.0f,  0.0f,  1.0f, // 0
		0.8, -1, 0.3, 0.0f,  0.0f,  1.0f, // 1
		0.8,  1, 0.3,  0.0f,  0.0f,  1.0f, // 2
		-0.8,  1, 0.3,  0.0f,  0.0f,  1.0f, // 3

		 // right
		 0.8,  1,  0.3, 1.0f,  0.0f,  0.0f, // 4
		0.8,  1, -0.3,  1.0f,  0.0f,  0.0f, // 5
		0.8, -1, -0.3, 1.0f,  0.0f,  0.0f, // 6
		 0.8, -1,  0.3,  1.0f,  0.0f,  0.0f, // 7

		// back
		-0.8, -1, -0.3,  0.0f,  0.0f,  -1.0f, // 8 
		0.8,  -1, -0.3,  0.0f,  0.0f,  -1.0f, // 9
		0.8,   1, -0.3,  0.0f,  0.0f,  -1.0f, // 10
		-0.8,  1, -0.3,  0.0f,  0.0f,  -1.0f, // 11

		 // left
		 -0.8, -1, -0.3,  -1.0f,  0.0f,  0.0f, // 12
		 -0.8, -1,  0.3,  -1.0f,  0.0f,  0.0f, // 13
		 -0.8,  1,  0.3,  -1.0f,  0.0f,  0.0f, // 14
		 -0.8,  1, -0.3,  -1.0f,  0.0f,  0.0f, // 15

		// upper
		0.8, 1,  0.3,    0.0f,  1.0f,  0.0f, // 16
		-0.8, 1,  0.3,   0.0f,  1.0f,  0.0f, // 17
		-0.8, 1, -0.3,  0.0f,  1.0f,  0.0f, // 18
		0.8, 1, -0.3,    0.0f,  1.0f,  0.0f, // 19

		// bottom
		-0.8, -1, -0.3,  0.0f,  -1.0f,  0.0f, // 20
		0.8, -1, -0.3,   0.0f,  -1.0f,  0.0f, // 21
		0.8, -1,  0.3,   0.0f,  -1.0f,  0.0f, // 22
		-0.8, -1,  0.3,  0.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::BuildColoredCube2() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-0.8, -1, 2.5, 0.0f,  1.0f,  1.0f, // 0
		0.8, -1, 2.5,0.0f,  1.0f,  1.0f, // 1
		0.8,  1, 2.5,   0.0f,  1.0f,  1.0f, // 2
		-0.8,  1, 2.5,   0.0f,  1.0f,  1.0f, // 3

		 // right
		 0.8,  1,  1.9, 1.0f,  0.0f,  0.0f, // 4
		0.8,  1, 2.5,  1.0f,  0.0f,  0.0f, // 5
		0.8, -1, 2.5, 1.0f,  0.0f,  0.0f, // 6
		 0.8, -1,  1.9, 1.0f,  0.0f,  0.0f, // 7

		// back
		-0.8, -1, 1.9, 0.0f,  01.0f,  -1.0f, // 8 
		0.8,  -1, 1.9,  0.0f,  01.0f,  -1.0f, // 9
		0.8,   1, 1.9,  0.0f,  01.0f,  -1.0f, // 10
		-0.8,  1, 1.9, 0.0f,  01.0f,  -1.0f, // 11

		 // left
		 -0.8, -1, 2.5,  -1.0f,  0.0f,  0.0f, // 12
		-0.8, -1,  1.9,  -1.0f,  0.0f,  0.0f, // 13
		 -0.8,  1,  1.9,  -1.0f,  0.0f,  0.0f, // 14
		-0.8,  1, 2.5,  -1.0f,  0.0f,  0.0f, // 15

		// upper
		0.8, 1,  2.5,   0.0f,  1.0f,  0.0f, // 16
		-0.8, 1,  2.5,    0.0f,  1.0f,  0.0f, // 17
		-0.8, 1, 1.9,   0.0f,  1.0f,  0.0f, // 18
		0.8, 1, 1.9,   0.0f,  1.0f,  0.0f, // 19

		// bottom
		-0.8, -1, 1.9,  0.0f,  -1.0f,  0.0f, // 20
		0.8, -1, 1.9,   0.0f,  -1.0f,  0.0f, // 21
		0.8, -1,  2.5,   0.0f,  -1.0f,  0.0f, // 22
		-0.8, -1,  2.5,  0.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::BuildColoredCube3() {
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-1.5, 1, 3,   0.0f,  0.0f,  1.0f, // 0
		1.5, 1, 3,    0.0f,  0.0f,  1.0f, // 1
		1.5,  1.2, 3,   0.0f,  0.0f,  1.0f, // 2
		-1.5,  1.2, 3,   0.0f,  0.0f,  1.0f, // 3

		 // right
		1.5,  1,  -0.8,  1.0f,  0.0f,  0.0f, // 4
		1.5,  1, 3,     1.0f,  0.0f,  0.0f, // 5
		1.5, 1.2, 3,      1.0f,  0.0f,  0.0f, // 6
		1.5, 1.2,  -0.8,  1.0f,  0.0f,  0.0f, // 7

		// back
		-1.5, 1.2, -0.8,  0.0f,  0.0f,  -1.0f, // 8 
		1.5,  1.2, -0.8,  0.0f,  0.0f,  -1.0f, // 9
		1.5,   1, -0.8,  0.0f,  0.0f,  -1.0f, // 10
		-1.5,  1, -0.8, 0.0f,  0.0f,  -1.0f, // 11

		 // left
		-1.5, 1.2, 3,  -1.0f,  0.0f,  0.0f, // 12
		-1.5, 1.2,  -0.8,  -1.0f,  0.0f,  0.0f, // 13
		-1.5,  1,  -0.8, -1.0f,  0.0f,  0.0f, // 14
		-1.5,  1, 3,  -1.0f,  0.0f,  0.0f, // 15

		// upper
		1.5, 1.2,  3,     0.0f,  1.0f,  0.0f, // 16
		-1.5, 1.2,  3,     0.0f,  1.0f,  0.0f, // 17
		-1.5, 1.2,-0.8,  0.0f,  1.0f,  0.0f, // 18
		1.5, 1.2, -0.8,  0.0f,  1.0f,  0.0f, // 19

		// bottom
		-1.5, 1, -0.8,  0.0f,  -1.0f,  0.0f, // 20
		1.5, 1, -0.8,   0.0f,  -1.0f,  0.0f, // 21
		1.5, 1,  3,  0.0f,  -1.0f,  0.0f, // 22
		-1.5, 1,  3,  0.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::BuildTexturedCube()
{
	...
	int width, height;
	unsigned char* image = SOIL_load_image("stone.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-0.8, -1, 0.3, 0, 0, 0.0f,  0.0f,  1.0f, // 0
		0.8, -1, 0.3, 1, 0,  0.0f,  0.0f,  1.0f, // 1
		0.8,  1, 0.3, 1, 1,  0.0f,  0.0f,  1.0f, // 2
		-0.8,  1, 0.3, 0, 1, 0.0f,  0.0f,  1.0f, // 3

		 // right
		 0.8,  1,  0.3, 0, 0, 1.0f,  0.0f,  0.0f, // 4
		0.8,  1, -0.3, 1, 0, 1.0f,  0.0f,  0.0f, // 5
		0.8, -1, -0.3, 1, 1, 1.0f,  0.0f,  0.0f, // 6
		 0.8, -1,  0.3, 0, 1, 1.0f,  0.0f,  0.0f, // 7

		// back
		-0.8, -1, -0.3, 0, 0, 0.0f,  0.0f,  -1.0f, // 8 
		0.8,  -1, -0.3, 1, 0, 0.0f,  0.0f,  -1.0f, // 9
		0.8,   1, -0.3, 1, 1, 0.0f,  0.0f,  -1.0f, // 10
		-0.8,  1, -0.3, 0, 1, 0.0f,  0.0f,  -1.0f, // 11

		 // left
		 -0.8, -1, -0.3, 0, 0, -1.0f,  0.0f,  0.0f, // 12
		 -0.8, -1,  0.3, 1, 0, -1.0f,  0.0f,  0.0f, // 13
		 -0.8,  1,  0.3, 1, 1, -1.0f,  0.0f,  0.0f, // 14
		 -0.8,  1, -0.3, 0, 1, -1.0f,  0.0f,  0.0f, // 15

		// upper
		0.8, 1,  0.3, 0, 0,   0.0f,  1.0f,  0.0f, // 16
		-0.8, 1,  0.3, 1, 0,   0.0f,  1.0f,  0.0f, // 17
		-0.8, 1, -0.3, 1, 1,  0.0f,  1.0f,  0.0f, // 18
		0.8, 1, -0.3, 0, 1,   0.0f,  1.0f,  0.0f, // 19

		// bottom
		-0.8, -1, -0.3, 0, 0, 0.0f,  -1.0f,  0.0f, // 20
		0.8, -1, -0.3, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
		0.8, -1,  0.3, 1, 1,  0.0f,  -1.0f,  0.0f, // 22
		-0.8, -1,  0.3, 0, 1, 0.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::BuildTexturedCube2()
{
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-0.8, -1, 2.5, 0, 0,  0.0f,  1.0f,  1.0f, // 0
		0.8, -1, 2.5, 1, 0,   0.0f,  1.0f,  1.0f, // 1
		0.8,  1, 2.5, 1, 1,  0.0f,  1.0f,  1.0f, // 2
		-0.8,  1, 2.5, 0, 1,  0.0f,  1.0f,  1.0f, // 3

		 // right
		 0.8,  1,  1.9, 0, 0, 1.0f,  0.0f,  0.0f, // 4
		0.8,  1, 2.5, 1, 0, 1.0f,  0.0f,  0.0f, // 5
		0.8, -1, 2.5, 1, 1, 1.0f,  0.0f,  0.0f, // 6
		 0.8, -1,  1.9, 0, 1, 1.0f,  0.0f,  0.0f, // 7

		// back
		-0.8, -1, 1.9, 0, 0, 0.0f,  01.0f,  -1.0f, // 8 
		0.8,  -1, 1.9, 1, 0, 0.0f,  01.0f,  -1.0f, // 9
		0.8,   1, 1.9, 1, 1, 0.0f,  01.0f,  -1.0f, // 10
		-0.8,  1, 1.9, 0, 1,0.0f,  01.0f,  -1.0f, // 11

		 // left
		 -0.8, -1, 2.5, 0, 0, -1.0f,  0.0f,  0.0f, // 12
		-0.8, -1,  1.9, 1, 0, -1.0f,  0.0f,  0.0f, // 13
		 -0.8,  1,  1.9, 1, 1, -1.0f,  0.0f,  0.0f, // 14
		-0.8,  1, 2.5, 0, 1, -1.0f,  0.0f,  0.0f, // 15

		// upper
		0.8, 1,  2.5, 0, 0,   0.0f,  1.0f,  0.0f, // 16
		-0.8, 1,  2.5, 0, 0,   0.0f,  1.0f,  0.0f, // 17
		-0.8, 1, 1.9, 1, 1,  0.0f,  1.0f,  0.0f, // 18
		0.8, 1, 1.9, 0, 1,  0.0f,  1.0f,  0.0f, // 19

		// bottom
		-0.8, -1, 1.9, 0, 0, 0.0f,  -1.0f,  0.0f, // 20
		0.8, -1, 1.9, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
		0.8, -1,  2.5, 1, 1,  0.0f,  -1.0f,  0.0f, // 22
		-0.8, -1,  2.5, 0, 1, 0.0f,  -1.0f,  0.0f, // 23
	};
...
void Demo::BuildTexturedCube3()
{
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	int width, height;
	unsigned char* image = SOIL_load_image("whitemarble.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
	...
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MIN_FILTER, GL_LINEAR);
	glTexParameteri(GL_TEXTURE_2D, GL_TEXTURE_MAG_FILTER, GL_LINEAR);
	image = SOIL_load_image("whitemarble.png", &width, &height, 0, SOIL_LOAD_RGBA);
	glTexImage2D(GL_TEXTURE_2D, 0, GL_RGBA, width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, image);
	SOIL_free_image_data(image);
	glBindTexture(GL_TEXTURE_2D, 0);
	...
	float vertices[] = {
		// format position, tex coords
		// front
		-1.5, 1, 3, 0, 0,  0.0f,  0.0f,  1.0f, // 0
		1.5, 1, 3, 1, 0,   0.0f,  0.0f,  1.0f, // 1
		1.5,  1.2, 3, 1, 1,  0.0f,  0.0f,  1.0f, // 2
		-1.5,  1.2, 3, 0, 1,  0.0f,  0.0f,  1.0f, // 3

		 // right
		1.5,  1,  -0.8, 0, 0,  1.0f,  0.0f,  0.0f, // 4
		1.5,  1, 3, 1, 0,      1.0f,  0.0f,  0.0f, // 5
		1.5, 1.2, 3, 1, 1,     1.0f,  0.0f,  0.0f, // 6
		1.5, 1.2,  -0.8, 0, 1, 1.0f,  0.0f,  0.0f, // 7

		// back
		-1.5, 1.2, -0.8, 0, 0, 0.0f,  0.0f,  -1.0f, // 8 
		1.5,  1.2, -0.8, 1, 0,  0.0f,  0.0f,  -1.0f, // 9
		1.5,   1, -0.8, 1, 1, 0.0f,  0.0f,  -1.0f, // 10
		-1.5,  1, -0.8, 0, 1, 0.0f,  0.0f,  -1.0f, // 11

		 // left
		-1.5, 1.2, 3, 0, 0, -1.0f,  0.0f,  0.0f, // 12
		-1.5, 1.2,  -0.8, 1, 0, -1.0f,  0.0f,  0.0f, // 13
		-1.5,  1,  -0.8, 1, 1, -1.0f,  0.0f,  0.0f, // 14
		-1.5,  1, 3, 0, 1, -1.0f,  0.0f,  0.0f, // 15

		// upper
		1.5, 1.2,  3, 0, 0,    0.0f,  1.0f,  0.0f, // 16
		-1.5, 1.2,  3, 1, 0,    0.0f,  1.0f,  0.0f, // 17
		-1.5, 1.2,-0.8, 1, 1, 0.0f,  1.0f,  0.0f, // 18
		1.5, 1.2, -0.8, 0, 1, 0.0f,  1.0f,  0.0f, // 19

		// bottom
		-1.5, 1, -0.8, 0, 0, 0.0f,  -1.0f,  0.0f, // 20
		1.5, 1, -0.8, 1, 0,  0.0f,  -1.0f,  0.0f, // 21
		1.5, 1,  3, 1, 1,  0.0f,  -1.0f,  0.0f, // 22
		-1.5, 1,  3, 0, 1, 0.0f,  -1.0f,  0.0f, // 23
	};
